...
using ProductsResourceServer.Model;
using ProductsResourceServer.Repositories;
using ProductsResourceServer.Repositories.Dapper;
...
namespace ProductsResourceServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IProductContext, ProductContextDapper>();
        }
